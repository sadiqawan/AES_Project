...
class UpdateSwitchesView extends StatefulWidget {
  const UpdateSwitchesView({super.key});

  @override
  State<UpdateSwitchesView> createState() => _UpdateSwitchesViewState();
}

class _UpdateSwitchesViewState extends State<UpdateSwitchesView> {
  @override
