...
class UpdateOthersView extends StatefulWidget {
  const UpdateOthersView({super.key});

  @override
  State<UpdateOthersView> createState() => _UpdateOthersViewState();
}

class _UpdateOthersViewState extends State<UpdateOthersView> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Passive Data')),
      body: StreamBuilder(
        stream:
